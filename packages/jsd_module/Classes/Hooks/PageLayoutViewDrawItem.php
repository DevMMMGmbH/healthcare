<?php
namespace JsdModule\JsdModule\Hooks;
...
class PageLayoutViewDrawItem implements PageLayoutViewDrawItemHookInterface
{
    ...
    'jsdmodule_jsdmod3erteaser' => 'Jsdmod3erteaser',
    'jsdmodule_jsdmodakkordeon' => 'Jsdmodakkordeon',
    'jsdmodule_jsdmodankerliste' => 'Jsdmodankerliste',
    'jsdmodule_jsdmodbereichsteaser' => 'Jsdmodbereichsteaser',
    'jsdmodule_jsdmodbildergalerie' => 'Jsdmodbildergalerie',
    'jsdmodule_jsdmodbilderkachel' => 'Jsdmodbilderkachel',
    'jsdmodule_jsdmodbildslider' => 'Jsdmodbildslider',
    'jsdmodule_jsdmodbildtextteaser' => 'Jsdmodbildtextteaser',
    'jsdmodule_jsdmodbuehnedetailseite' => 'Jsdmodbuehnedetailseite',
    'jsdmodule_jsdmoddownload' => 'Jsdmoddownload',
    'jsdmodule_jsdmodfooter' => 'Jsdmodfooter',
    'jsdmodule_jsdmodgmapbvgyoutube' => 'Jsdmodgmapbvgyoutube',
    'jsdmodule_jsdmodhighlightteaser' => 'Jsdmodhighlightteaser',
    'jsdmodule_jsdmodinfobox' => 'Jsdmodinfobox',
    'jsdmodule_jsdmodkontakt' => 'Jsdmodkontakt',
    'jsdmodule_jsdmodleistungen' => 'Jsdmodleistungen',
    'jsdmodule_jsdmodlinkliste' => 'Jsdmodlinkliste',
    'jsdmodule_jsdmodnavigation' => 'Jsdmodnavigation',
    'jsdmodule_jsdmodschnellzugriffsteaser' => 'Jsdmodschnellzugriffsteaser',
    'jsdmodule_jsdmodseointrotext' => 'Jsdmodseointrotext',
    'jsdmodule_jsdmodsimplespeak' => 'Jsdmodsimplespeak',
    'jsdmodule_jsdmodzahltext' => 'Jsdmodzahltext',
    'jsdmodule_jsdmodzitattext' => 'Jsdmodzitattext',
];
    ...
    protected function configureView(array $pageTsConfig, $contentType)
    {
        ...
        if (!empty($previewConfiguration[$extensionKey]['templateRootPath'])) {
            $this->view->setTemplateRootPaths([
                'EXT:jsd_module/Resources/Private/Backend/Templates/Content/',
